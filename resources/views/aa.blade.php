...
<head>
    ...
    <meta name="description" content="BlueGate Cargo Delivery Limited - We Deal With your Logistics & Shipping Needs!">
<meta property="og:image" content="https://bluegatecargo.com/images/banner_1.png"/>
<meta property="twitter:image" content="https://bluegatecargo.com/images/banner_1.png"/>
    <meta name="author" content="DesignClub" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Tracking Details - BlueGate Cargo Delivery Limited</title>
...
s1.async=true;
s1.src='https://embed.tawk.to/60fa30fa649e0a0a5ccd88d7/1fb8kul93';
s1.charset='UTF-8';
s1.setAttribute('crossorigin','*');
s0.parentNode.insertBefore(s1,s0);
})();
</script>
<!--End of Tawk.to Script-->        <!--Page Header-->
...
<!--            <p class="inner-subtitle text-white">For those of you who are serious about having more, doing more, giving more and being more, success is achievable. Yes for more we do it through shipping, fastest shipping network accross the globe fast and safe</p>-->
  ...
  <section class="feature-area section-gap" style="margin-bottom: 120px">
                    ...
                    <div class="col-md-6 text-right">
				                <h4><b>Tracking No : CT0EBZRBK6SD</b>  </h4>
				            </div>
				            <hr>
				            <br>
				            <br>
				                        ...
				                        <div class="panel panel-primary">
				                            ...
				                            <table class="table table-hover" id="dev-table">
				                                <tbody>
				                                    ...
				                                    <tr>
				                                        <td><b>Email:</b> </td>
				                                        <td> elenasura27@gmail.com </td>
				                                    </tr>
				                                    <tr>
				                                        <td><b>Address:</b> </td>
				                                        <td> Syria Military Camp</td>
				                                    </tr>
				                                </tbody>
				                            </table>
				                        </div>
...
***Protected***</td>
				                                    ...
				                                    <tr>
				                                        <td><b>Address:</b></td>
				                                        <td> 2632 s 83th Ave Suite 100-155 Phoenix Arizona 85043</td>
				                                    </tr>
				                                </tbody>
				                            </table>
				                        </div>
...
<b> Active </b></td>
				                       ...
				                       <!--  <tr>
				                        ...
				                        <tr>
				                            <td class="text-right"><b>Current Location  <IMG SRC="images/service/loading.gif" style="height: 30px; width: 50px"> </b></td>
				                            <td class="col-xs-6"><marquee> Arizona, United States of America. &nbsp; </marquee></td>
				                        </tr>
				                       <!--  <tr>
...
<form action="https://bluegatecargo.com/search/currier" method="post" style="margin bottom:50px">
<input type="hidden" name="_token" value="KZ9CHUkum4Eag6Eh7KrFqZ4p7AaabpIY34ICLtT7">          <div class="form-group">
           
           <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Tracking Code" name="currier_invoice" value="" style="width:350px; background-color: lightgrey" >
          </div>
            ...
            <ul class="footer-contact list-unstyled">
              <li>
                ...
                <div class="footer-contact-info">
                  <span>Mount Pleasant, Breach Lane,</span>
                  <p class="mb-0"> Sittingbourne, England</p>
                </div>
              </li>
              <li>
                <div class="footer-contact-icon">
              ...
              <li>
                ...
                <div class="footer-contact-info">
                  <span>Info@bluegatecargo.com</span>
        ...
        <div class="copyright">
          <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6 text-left text-md-right mt-4 mt-md-0">
              <p class="mb-0 text-white">©️ 2021 BlueGate Cargo. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
