<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from codexpeed.com/html/CarGo Care Hub-html/index-2 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2024 10:08:11 GMT -->
  ...
  <body class="body-wrapper">
    ...
    <div id="preloader" class="preloader">
          ...
          <div class="row middle-bar justify-content-between align-items-center">
            <div class="col-xl-3 col-lg-12 col-6 text-lg-center text-xl-start">
              <div class="logo mb-lg-4 mb-xl-0">
                <a href="index"><img src="/logo/logo.png" alt="CarGo Care Hub" /></a>
              </div>
            </div>
            ...
            <div class="col-6 justify-content-end align-items-center d-flex d-lg-none">
              <div class="header-btn">
                <a href="track/" class="theme-btn">Track</a>
              </div>
              ...
              <div class="row">
                <div class="col-12 col-xxl-6 col-md-8">
                  <div class="hero-contents">
                    <h1 class="fs-lg animated" data-animation-in="fadeInUp" data-delay-in="0.1">
                      Quick <span>Transport</span>
                    </h1>
                    <p class="pe-lg-5 animated" data-animation-in="fadeInUp" data-delay-in="0.5">
                      We are Trusted 15+ Countries Worldwide We hire and build
                      your own remote dedicated development teams tailored to your
                      specific needs.
                    </p>
                    <a href="contact" class="theme-btn me-sm-4" data-animation-in="fadeInUp" data-delay-in="0.8">get a
                      quote <i class="fal fa-long-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                <div class="single-service-icon">
                  <div class="content">
                    ...
                    <div class="title">
                      <h6><a href="services-details">road freight</a></h6>
                    </div>
                  </div>
                  <a href="services-details" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                </div>
              </div>
              <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                <div class="single-service-icon">
                  <div class="content">
                    ...
                    <div class="title">
                      <h6><a href="services-details">air freight</a></h6>
                    </div>
                  </div>
                  <a href="services-details" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                </div>
              ...
              <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                <div class="single-service-icon">
                  <div class="content">
                    ...
                    <div class="title">
                      <h6><a href="services-details">ocean freight</a></h6>
                    </div>
                  </div>
                  <a href="services-details" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                </div>
              ...
              <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                <div class="single-service-icon">
                  <div class="content">
                    ...
                    <div class="title">
                      <h6><a href="services-details">train freight</a></h6>
                    </div>
                  </div>
                  <a href="services-details" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                </div>
              ...
              <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                <div class="single-service-icon">
                  <div class="content">
                    ...
                    <div class="title">
                      <h6><a href="services-details">drone freight</a></h6>
                    </div>
                  </div>
                  <a href="services-details" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                </div>
              ...
              <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                <div class="single-service-icon">
                  <div class="content">
                    ...
                    <div class="title">
                      <h6><a href="services-details">send gift</a></h6>
                    </div>
                  </div>
                  <a href="services-details" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                </div>
            ...
            <div class="col-lg-6 col-12">
              <div class="about-img-gallery me-lg-5 mb-5 mb-lg-0">
                <div class="about-img-left">
                  <img src="assets/img/home2/about-left.jpg" alt="CarGo Care Hub" />
                </div>
                <div class="about-img-center bg-cover" style="
                  background-image: url('assets/img/home2/about-center.jpg');
                "></div>
                <div class="about-img-right">
                  <img src="assets/img/home2/about-right.jpg" alt="CarGo Care Hub" />
                </div>
              </div>
            </div>
            <div class="col-lg-6 col-12">
              ...
              <div class="about-ceo d-sm-flex align-items-center wow fadeInUp" data-wow-delay=".7s">
                ...
                <div class="ceo-info">
                  ...
                  <span>CEO & Founder, CarGo Care Hub</span>
                </div>
          ...
          <div class="row">
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-freight-service wow fadeInUp">
                <h3><a href="services-details">Land Transport</a></h3>
                <p>
      ...
      <section class="cta-wrapper section-padding style-2 bg-cover"
        style="background-image: url('assets/img/cta-bg-2.jpg')">
        <div class="container">
          <div class="col-lg-8 offset-lg-2 col-12 text-center">
            <div class="cta-contents">
              <img src="/logo/logo.png" alt="CarGo Care Hub" />
              <h1 class="text-white mt-4 mt-md-5 mb-4">
                World’s Leading Contract Logistics Provider
              </h1>
              <a href="contact" class="theme-btn">make custom request <i class="fal fa-long-arrow-right"></i></a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row">
              ...
              <div class="tab-wrapper">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-noise-tab" data-bs-toggle="pill"
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-energy-tab" data-bs-toggle="pill" data-bs-target="#pills-energy"
                      type="button" role="tab" aria-controls="pills-energy" aria-selected="false">
                      Energy efficiency
                    </button>
                  </li>
                </ul>
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-noise" role="tabpanel"
                    aria-labelledby="pills-home-tab">
                    <div class="tab-contents">
                      <p>
                        Step forward to become one of 49,494 successful clients of
                        CarGo Care Hub and get in the front line with some shit
                        shat.
                      </p>
            ...
            <div class="col-xl-6 col-12 ps-xl-5">
              <div class="funfact-img ms-xl-5 mt-5 mt-xl-0">
                <img src="assets/img/home2/fact-img.jpg" alt="CarGo Care Hub" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-pricing-plan plan-1">
                ...
                <div class="plan-buy-btn">
                  <p>
                    Basic plan for small companies with one month subscription.
                  </p>
                  <a href="pricing" class="theme-btn">Purchase Now <i class="fal fa-long-arrow-right"></i></a>
                </div>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-pricing-plan active plan-2">
                ...
                <div class="plan-buy-btn">
                  <p>
                    Standard plan for small companies with one month subscription.
                  </p>
                  <a href="pricing" class="theme-btn">Purchase Now <i class="fal fa-long-arrow-right"></i></a>
                </div>
                <ul class="plan-service-list">
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-pricing-plan plan-3">
                ...
                <div class="plan-buy-btn">
                  <p>
                    Advanced plan for big companies with one month subscription.
                  </p>
                  <a href="pricing" class="theme-btn">Purchase Now <i class="fal fa-long-arrow-right"></i></a>
                </div>
                <ul class="plan-service-list">
          ...
          <div class="row">
            <div class="col-xl-3 col-md-6 col-12">
              <div class="single-team-member bg-cover" style="background-image: url('assets/img/team/5.jpg')">
                <div class="member-details">
                  <span>Founder</span>
                  <h3><a href="team-details">Salman Ahmed</a></h3>
                </div>
            ...
            <div class="col-xl-3 col-md-6 col-12">
              <div class="single-team-member bg-cover" style="background-image: url('assets/img/team/6.jpg')">
                <div class="member-details">
                  <span>CEO</span>
                  <h3><a href="team-details">Miranda H. Halim</a></h3>
                </div>
                <div class="social-icons">
                  <div class="plus-icon"><i class="fal fa-plus"></i></div>
                  <div class="top">
            ...
            <div class="col-xl-3 col-md-6 col-12">
              <div class="single-team-member bg-cover" style="background-image: url('assets/img/team/7.jpg')">
                <div class="member-details">
                  <span>Desginer</span>
                  <h3><a href="team-details">Alex D. Denzilan</a></h3>
                </div>
                <div class="social-icons">
                  <div class="plus-icon"><i class="fal fa-plus"></i></div>
                  <div class="top">
            ...
            <div class="col-xl-3 col-md-6 col-12">
              <div class="single-team-member bg-cover" style="background-image: url('assets/img/team/8.jpg')">
                <div class="member-details">
                  ...
                  <h3><a href="team-details">Kilmon L. Limona</a></h3>
                </div>
                <div class="social-icons">
                  <div class="plus-icon"><i class="fal fa-plus"></i></div>
                  <div class="top">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-xl-4 text-center text-lg-start col-lg-5 pe-lg-0">
              ...
              <a href="testimoinals" class="theme-btn mt-30">All testimonials</a>
            </div>
            <div class="col-lg-7 col-xl-8 col-12 mt-5 mt-lg-0">
              <div class="testimonial-carousel-active ps-xl-5 pe-xl-5">
                <div class="single-testimonial-card text-center">
                  <div class="client-img bg-cover bg-center" style="
                ...
                <div class="single-testimonial-card text-center">
                  <div class="client-img bg-cover bg-center"
                    style="background-image: url('assets/img/blog/author3.jpg')"></div>
                  <div class="client-info">
                    <h4>Ernest Smith</h4>
                ...
                <div class="single-testimonial-card text-center">
                  <div class="client-img bg-cover bg-center"
                    style="background-image: url('assets/img/blog/author2.jpg')"></div>
                  <div class="client-info">
                    <h4>Thomas Smith</h4>
                    ...
                    <div class="accordion-item">
                      ...
                      <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#accordion">
                        <div class="accordion-body">
                          ...
                          formula for our work, which is why our projects never
                          quite look or feel the same. Each of our spaces is the
                          result of our ability to listen.
                        </div>
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-xl-4 col-md-6">
              <div class="single-blog-item">
                ...
                <div class="content">
                  <h3>
                    <a href="news-details">Helping Companies in Their Green Transition</a>
                  </h3>
                  <p>
                    With the cargo business blasting, financier firms are bouncing
                  </p>
            ...
            <div class="col-xl-4 col-md-6">
              <div class="single-blog-item">
                ...
                <div class="content">
                  <h3>
                    <a href="news-details">Tips to Lowering Freight Shipping Costs</a>
                  </h3>
                  <p>
                    With the cargo business blasting, financier firms are bouncing
                  </p>
                  ...
                  <div class="post-meta d-flex align-items-center">
                    <div class="post-date">
                      <i class="fal fa-calendar-alt"></i>Jan 25, 2024
                    </div>
                    <div class="post-author">
                      <i class="fal fa-user-alt"></i> by <a href="#">admin</a>
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
              <div class="single-blog-item">
                ...
                <div class="content">
                  <h3>
                    <a href="news-details">Drivers Deliver Much More Than Products</a>
                  </h3>
                  <p>
                    With the cargo business blasting, financier firms are bouncing
                  </p>
                  ...
                  <div class="post-meta d-flex align-items-center">
                    <div class="post-date">
                      <i class="fal fa-calendar-alt"></i>Feb 14, 2024
                    </div>
                    <div class="post-author">
                      <i class="fal fa-user-alt"></i> by <a href="#">admin</a>
                    </div>
  ...
  <!-- Mirrored from codexpeed.com/html/CarGo Care Hub-html/index-2 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2024 10:08:36 GMT -->
