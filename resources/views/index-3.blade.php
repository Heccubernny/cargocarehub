<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from codexpeed.com/html/CarGo Care Hub-html/index-3 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2024 10:08:36 GMT -->
    ...
    <div id="preloader" class="preloader">
      <div class="animation-preloader">
        ...
        <div class="txt-loading">
          ...
          <span data-text-preloader="GO" class="letters-loading">
            GO
          </span>
          <span data-text-preloader="C" class="letters-loading">
            C
          ...
          <span data-text-preloader="HUB" class="letters-loading">
            HUB
          </span>
        </div>
        ...
        <div class="offset-menu-wrapper text-white">
          <div class="offset-menu-header">
            <div class="offset-menu-logo">
              <a href="index"><img src="/logo/logo.png" alt="logo" /></a>
            </div>
          </div>
          <!-- /.offset-menu-header -->
          <div class="offset-menu-section">
            <h3>About Us</h3>
            <p>
              CarGo Care Hub is the world’s driving worldwide coordinations
              supplier — we uphold industry and exchange the worldwide trade of
              merchandise through land transport.
            </p>
            <a href="contact" class="theme-btn minimal-btn mt-30">Consultation <i class="fas fa-arrow-right"></i></a>
          </div>
          <!-- /.offset-menu-section -->
          <div class="offset-menu-section">
            <h3>Contact Info</h3>
            <ul>
              <li>
                <span><i class="fal fa-map"></i></span>Rock St 12, Newyork City,
                USA
              </li>
              <li>
                <span><i class="fal fa-phone"></i></span>(000) 000-000-0000
              </li>
              <li>
                <span><i class="fal fa-envelope"></i></span>info@modinatheme.com
              </li>
              <li>
            ...
            <div class="row">
              <div class="col-lg-12 col-12 text-center">
                <div class="welcome-text">
                  <p>
                    Welcome to CarGo Care Hub Logistic & Cargo Services Company.
                    <a href="faq">Setting & Parivacy, Faq</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                    ...
                    <div class="mobile-nav">
                      ...
                      <div class="action-bar text-white">
                        ...
                        <div class="single-info-element">
                          ...
                          <div class="text">
                            <h5>Send us mail</h5>
                            <span>info@cargocarehub.org</span>
                          </div>
                        </div>
                        <div class="call-us">
                        ...
                        <a href="contact" class="theme-btn mt-4">Track Your Shipment</a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xl-2 col-lg-3 col-6 ps-lg-0 text-end">
                <div class="header-btn-cta">
                  <a href="track/" class="theme-btn">Track <i class="ms-2 fal fa-long-arrow-right"></i></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="hero-slide-wrapper hero-3">
        <div class="hero-slider-3 CarGo Care Hub-dots">
              ...
              <div class="row align-items-center">
                <div class="col-12 col-lg-9 mt-5 mt-lg-0 order-2 order-lg-1 text-center text-lg-start">
                  <div class="hero-contents text-white">
                    <p class="animated" data-animation-in="fadeInLeft" data-delay-in="0.04">
                      We Have 30 Years Of Experience In Transport
                    </p>
                    <h1 class="animated" data-animation-in="fadeInLeft" data-delay-in="0.3">
                      Moving Never <br />Looked so Superior
                    </h1>
                    <a href="services" class="theme-btn animated" data-animation-in="fadeInLeft"
                      data-delay-in="0.9">Service we provide <i class="fas fa-arrow-right"></i></a>
                    <a href="about" class="theme-btn minimal-btn animated" data-animation-in="fadeInLeft"
                      data-delay-in="0.6">learn more <i class="fas fa-arrow-right"></i></a>
                  </div>
                </div>
          ...
          <div class="single-slide bg-cover" style="background-image: url('assets/img/slide3.jpg')">
            <div class="container">
              <div class="row align-items-center">
                <div class="col-12 col-lg-9 mt-5 mt-lg-0 order-2 order-lg-1 text-center text-lg-start">
                  <div class="hero-contents text-white">
                    ...
                    <h1 class="animated" data-animation-in="fadeInLeft" data-delay-in="0.3">
                      Best Transport <br />service in the world
                    </h1>
                    <a href="services" class="theme-btn animated" data-animation-in="fadeInLeft"
                      data-delay-in="0.9">Service we provide <i class="fas fa-arrow-right"></i></a>
                    <a href="about" class="theme-btn minimal-btn animated" data-animation-in="fadeInLeft"
          ...
          <div class="row">
            ...
            <div class="col-lg-7 mt-5 mt-lg-0 ps-lg-5">
              ...
              <div class="about-info-contents">
                ...
                <p>
                  Just as we’ve found with the truck driver shortage, the impetus
                  behind skilled labor leaving is many-fold. Demographics play a
                  large role—a massive amount of pilots are expected to hang up
                  their hats in the next few years
                </p>
              </div>
          ...
          <div class="col-12 col-lg-12 mb-40">
            <div class="block-contents text-center">
              <div class="section-title">
                ...
                <h2>CarGo Care Hub <span>Services</span></h2>
              </div>
            </div>
          </div>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-our-service">
                ...
                <div class="content">
                  ...
                  <h3><a href="services-details">air freight</a></h3>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-our-service">
                ...
                <div class="content">
                  ...
                  <h3><a href="services-details">Ocean freight</a></h3>
                  <p>Quis autem veleum reprehenderit quin volupta esse quam</p>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-our-service">
                ...
                <div class="content">
                  ...
                  <h3><a href="services-details">Road freight</a></h3>
                  <p>Quis autem veleum reprehenderit quin volupta esse quam</p>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-our-service">
                ...
                <div class="content">
                  ...
                  <h3><a href="services-details">Rail freight</a></h3>
                  <p>Quis autem veleum reprehenderit quin volupta esse quam</p>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-our-service">
                ...
                <div class="content">
                  ...
                  <h3><a href="services-details">Bike freight</a></h3>
                  <p>Quis autem veleum reprehenderit quin volupta esse quam</p>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-our-service">
                <div class="thumb bg-cover" style="
                  background-image: url('assets/img/services/drone-fright.jpg');
                "></div>
                <div class="content">
                  <div class="icon">
                    <i class="flaticon-drone-2"></i>
                  </div>
                  <h3><a href="services-details">Drone freight</a></h3>
                  <p>Quis autem veleum reprehenderit quin volupta esse quam</p>
                </div>
              </div>
            </div>
      ...
      <section class="request-a-quote-section theme-bg bg-cover calculate-wrapper section-padding"
        style="background-image: url('assets/img/cost-bg.jpg')">
        <div class="container">
          <div class="row">
                ...
                <div class="request-quote-form">
                  <form action="#">
                    <div class="row d-flex align-item-center">
                      ...
                      <div class="col-sm-6 col-12">
                        <select name="ftype" class="wide" id="CarGo Care Hub">
        ...
        <div class="container">
          <div class="col-12 col-lg-12 mb-40">
            <div class="block-contents text-center">
              <div class="section-title">
                ...
                <h2>Provide Future<span> of Delivery</span></h2>
              </div>
            </div>
          </div>
          ...
          <div class="row text-center">
              ...
              <div class="single-feature-item">
                ...
                <div class="content">
                  ...
                  <p>
                    ...
                    accusantiu doloremque laudantium totam remap
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12">
              <div class="single-feature-item">
                <div class="icon">
                  <img src="assets/img/icons/world.png" alt="" />
                </div>
                <div class="content">
                  <h2>25 million</h2>
            ...
            <div class="col-lg-4 col-md-6 col-12">
              <div class="single-feature-item">
                <div class="icon">
                  <img src="assets/img/icons/store.png" alt="" />
                </div>
                <div class="content">
                  <h2>2 million</h2>
                  <span>Stored in stock</span>
                  <p>
                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                    accusantiu doloremque laudantium totam remap
                  </p>
      ...
      <section class="skill-wrapper section-padding section-bg">
        <div class="container">
          <div class="row">
            <div class="col-xl-6 col-lg-6 col-12 pe-xl-5">
              <div class="block-contents mb-20 pr-30">
                <div class="section-title">
                  <h5 class="textleft">skills</h5>
                  <span>Expertise Areas</span>
                  <h2>Our <span>Skills up</span></h2>
                </div>
                <p>
                  It's the greatest tool ever invented to connect and learn and
                  work and play. But most people are stuck with just one
                  overpriced.
                </p>
              </div>
              ...
              <div class="skill-wrapper">
                <div class="single-progress-bar">
                  ...
                  <div class="progress">
                    <div class="progress-bar wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".1s"
                ...
                <div class="single-progress-bar">
                  ...
                  <div class="progress">
                    <div class="progress-bar wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".5s"
                ...
                <div class="single-progress-bar">
                  <div class="title justify-content-between d-flex align-items-center">
                    ...
                    <span class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="1.6s">98%</span>
                  </div>
                  <div class="progress">
                    <div class="progress-bar wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".9s"
                      role="progressbar" style="width: 98%"></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-6 ps-lg-5 mt-5 mt-lg-0 col-lg-6 col-12">
              <div class="skills-video d-flex justify-content-center align-items-center bg-cover bg-center"
                style="background-image: url('assets/img/faq-video-pup.jpg')">
                <div class="video-play-btn">
                  <a href="https://www.youtube.com/watch?v=E1xkXZs0cAQ" class="popup-video play-video"><i
                      class="fas fa-play"></i></a>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-xl-3 col-md-6 col-12">
              <div class="team-member-card bg-cover" style="background-image: url('/assets/img/admin.jpeg')">
                <div class="profile-info-card">
                  <span>Admin</span>
                  <h5><a href="team-details">Amanda Martin</a></h5>
            ...
            <div class="col-xl-3 col-md-6 col-12">
              <div class="team-member-card bg-cover" style="background-image: url('/assets/img/founder.jpeg')">
                <div class="profile-info-card">
                  <span>Founder</span>
                  <h5><a href="team-details">Michael Brown</a></h5>
                  <div class="social-link">
                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                    <a href="#"><i class="fab fa-twitter"></i></a>
                    <a href="#"><i class="fab fa-instagram"></i></a>
            ...
            <div class="col-xl-3 col-md-6 col-12">
              <div class="team-member-card bg-cover" style="background-image: url('assets/img/ctoo.jpeg')">
                <div class="profile-info-card">
                  <span>CTOO</span>
                  <h5><a href="team-details">David Lee</a></h5>
                  <div class="social-link">
                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                    <a href="#"><i class="fab fa-twitter"></i></a>
                    <a href="#"><i class="fab fa-instagram"></i></a>
            ...
            <div class="col-xl-3 col-md-6 col-12">
              <div class="team-member-card bg-cover" style="background-image: url('/assets/img/support.jpeg')">
                <div class="profile-info-card">
                  <span>Support</span>
                  <h5><a href="team-details">John Walton</a></h5>
                  <div class="social-link">
                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                    <a href="#"><i class="fab fa-twitter"></i></a>
                    <a href="#"><i class="fab fa-instagram"></i></a>
      ...
      <section class="faq-wrapper section-padding section-bg">
          ...
          <div class="row equal">
            <div class="col-lg-6 col-12">
              <div class="block-contents mb-20">
                <div class="section-title">
                  ...
                  <h2>may our faq<span> help you properly</span></h2>
                </div>
              </div>
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#accordion">
                      <div class="accordion-body">
                        ...
                        for our work, which is why our projects never quite look
                        or feel the same. Each of our spaces is the result of our
                        ability to listen.
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-lg-4 offset-lg-1 col-12 mt-5 mt-lg-0 d-none">
              <div class="investors-inquire-card text-white text-center">
                ...
                <div class="investor-img bg-cover" style="background-image: url('assets/img/investor.jpg')"></div>
                <div class="investors-data mt-3">
                  <div class="profile-data mb-4">
                    <h4>Nowrin Jaan</h4>
                    <h6>Manager of Relationship Team</h6>
                    <p>Head Office - CarGo Care Hub LTD</p>
                  </div>
                  ...
                  <div class="investors-contact">
                    <p>
                      <i class="fal fa-envelope"></i> investorinquire@example.com
                    </p>
                  </div>
                </div>
        ...
        <div class="faq-banner-half bg-cover d-none d-lg-block" style="background-image: url('assets/img/mask-bg.jpg')">
        </div>
      </section>
      ...
      <div class="video-pop-up-wrapper section-padding bg-cover"
        style="background-image: url('assets/img/full-video-bg.jpg')">
        <div class="container">
          <div class="row">
          ...
          <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-4 col-lg-3 col-12">
              <div class="single-brand-logo">
                <img src="assets/img/brand/1.png" alt="CarGo Care Hub" />
              </div>
            </div>
            <div class="col-md-4 col-lg-3 col-12">
              <div class="single-brand-logo">
                <img src="assets/img/brand/2.png" alt="CarGo Care Hub" />
              </div>
            </div>
            <div class="col-md-4 col-lg-3 col-12">
              <div class="single-brand-logo">
                <img src="assets/img/brand/3.png" alt="CarGo Care Hub" />
              </div>
            </div>
            <div class="col-md-4 col-lg-3 col-12">
              <div class="single-brand-logo">
                <img src="assets/img/brand/4.png" alt="CarGo Care Hub" />
              </div>
            </div>
            <div class="col-md-4 col-lg-3 col-12">
              <div class="single-brand-logo">
                <img src="assets/img/brand/5.png" alt="CarGo Care Hub" />
              </div>
            </div>
            <div class="col-md-4 col-lg-3 col-12">
              <div class="single-brand-logo">
                <img src="assets/img/brand/6.png" alt="CarGo Care Hub" />
              </div>
            </div>
            <div class="col-md-4 col-lg-3 col-12">
              <div class="single-brand-logo">
                <img src="assets/img/brand/7.png" alt="CarGo Care Hub" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="col-lg-8 offset-lg-2 col-12 text-center">
            <div class="cta-contents">
              ...
              <a href="contact" class="theme-btn">make custom request</a>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-news-box">
                <div class="featured-thumb bg-cover" style="background-image: url('assets/img/blog/b1.jpg')">
                  <div class="post-cat">
                    <a href="news">logistics</a>
                  </div>
                </div>
                <div class="content">
                  <div class="meta d-flex">
                    <div class="author me-2">
                      <i class="fal fa-user"></i><a href="#">CarGo Care Hub</a>
                    </div>
                    |
                    <div class="date ms-2">
                  ...
                  <h3>
                    <a href="news-details">Our Mission 2040: Zero Emissions</a>
                  </h3>
                  <a class="read-btn" href="news-details">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-news-box">
                ...
                <div class="content">
                  ...
                  <h3>
                    <a href="news-details">Key Logistics Trends in Life Sciences 2021</a>
                  </h3>
                  <a class="read-btn" href="news-details">Read More</a>
                </div>
              </div>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="single-news-box">
                ...
                <div class="content">
                  ...
                  <h3>
                    <a href="news-details">5 Benefits of Working with a Freight Broker</a>
                  </h3>
                  <a class="read-btn" href="news-details">Read More</a>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-sm-6 col-xl-3">
                <div class="about-CarGo Care Hub pe-md-5 pe-xl-0">
                  <a href="index">
                    <img src="assets/img/footer-logo.png" alt="CarGo Care Hub" />
                  </a>
                  <p style="color: white">
                    CarGo Care Hub Logistics Services is a global supplier of
                    transport and logistics solutions. We have offices in more
                    than 20 countries and agents.
                  </p>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-xl-2">
                <div class="single-footer-wid ps-xl-4">
                  ...
                  <ul>
                    ...
                    <li><a href="contact">Request a Freight</a></li>
                    <li><a href="services">Track & Trace</a></li>
                    <li><a href="services">Rail Freight</a></li>
                    <li><a href="services">Maritime Transport</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6 col-12">
                  <div class="copy-rights">
                    <p>
                      &copy;2024 <strong>CarGo Care Hub</strong>, All Rights
                      Reserved
                    </p>
                  </div>
                </div>
  ...
  <!-- Mirrored from codexpeed.com/html/CarGo Care Hub-html/index-3 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2024 10:08:49 GMT -->
