<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from codexpeed.com/html/CarGo Care Hub-html/index by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2024 10:04:41 GMT -->
  <head>
    <!-- ========== Meta Tags ========== -->
    <meta charset="UTF-8" />
  ...
  <body class="body-wrapper">
    ...
    <div id="preloader" class="preloader">
      <div class="animation-preloader">
        ...
        <div class="txt-loading">
          ...
          <span data-text-preloader="GO" class="letters-loading"> GO </span>
          <span data-text-preloader="C" class="letters-loading"> C </span>
          <span data-text-preloader="A" class="letters-loading"> A </span>
          <span data-text-preloader="R" class="letters-loading"> R </span>
          <span data-text-preloader="E" class="letters-loading"> E </span>
          <br />
          <span data-text-preloader="HUB" class="letters-loading"> HUB </span>
        </div>
    ...
    <div class="top-bar-wrapper d-none d-sm-block">
      <div class="container d-flex justify-content-between align-items-center">
        <div class="top-left">
          <a href="tel:987-098-098-09"
            ><i class="fal fa-phone-volume"></i>987-098-098-09</a
          >
          <a href="mailto:info@cargocarehub.org"
            ><i class="fal fa-envelope"></i>info@cargocarehub.org</a
          >
          <a href="#"
            ><i class="fal fa-map-marker-alt"></i>942 S Shady Grove Rd, Memphis,
            TN</a
          >
        </div>
    ...
    <header class="header-1">
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          <div
            class="col-lg-9 text-end p-lg-0 d-none d-lg-flex justify-content-between align-items-center"
          >
            <div class="menu-wrap">
              <div class="main-menu">
                <ul>
            ...
            <div class="header-right-element">
              <a href="track/" class="theme-btn"
                >Track <i class="fal fa-long-arrow-right"></i
              ></a>
              ...
              <div class="mobile-nav">
                ...
                <nav class="sidebar-nav">
                  <ul class="metismenu" id="mobile-menu">
                    <li><a class="has-arrow" href="index">Home</a></li>
                    <li><a href="about">about</a></li>
                    <li><a href="services">services</a></li>
                    <li>
                ...
                <div class="action-bar text-white">
                  ...
                  <a href="track/" class="theme-btn mt-4"
    ...
    <section class="hero-wrapper hero-1">
      <div class="hero-slider-active CarGo Care Hub-dots">
        <div class="single-slide">
          <div
            class="slide-bg bg-cover wow zoomIn"
            style="background-image: url('assets/img/home1/slide1.jpg')"
          ></div>
          <div class="container">
            <div class="row">
              <div class="col-12 col-xxl-6 col-lg-8 col-sm-10">
                <div class="hero-contents pe-lg-3 text-white">
                  <h1
                    ...
                    data-delay-in="0.2"
                  >
                    Innovative thing <span>Provide</span>
                  </h1>
                  <p
                    class="pe-lg-5 mb-4 animated"
                    data-animation-in="fadeInRight"
                    data-delay-in="0.5"
                  >
                  ...
                  <a
                    ...
                    data-animation-in="fadeInRight"
                    data-delay-in="0.8"
                    class="theme-btn me-sm-4 mt-4 animated"
                    >Track your shipment</a
                  >
                </div>
              </div>
          ...
          <div
            class="slide-pop-video-box-wrapper d-flex text-white align-items-center"
            data-animation-in="fadeInRight"
            data-delay-in="1s"
          >
            ...
            <div
              class="video-wrapper bg-overlay bg-cover bg-center col-6 justify-content-center align-items-center"
        ...
        <div class="single-slide">
          <div
            ...
            style="background-image: url('assets/img/home1/slide2.jpg')"
          ></div>
          <div class="container">
            <div class="row">
              <div class="col-12 col-xxl-6 col-lg-8 col-sm-10">
                <div class="hero-contents pe-lg-3 text-white">
                  <h1
                    ...
                    data-delay-in="0.2"
                  >
                    best Logistics in the <span>World</span>
                  </h1>
                  <p
                    class="pe-lg-5 mb-4"
                    data-animation-in="fadeInRight"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
        <symbol
          ...
          stroke="currentColor"
        >
          <circle r="20" cy="22" cx="22" id="CarGo Care Hubcircle" />
        </symbol>
      </svg>
    </section>
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 ps-lg-5">
            ...
            <div class="about-info-contents">
              <p>
                ...
                of merchandise through land transport.CarGo Care Hub is the
                world’s driving worldwide coordinations supplier — we uphold
            ...
            <div class="company-ceo d-flex align-items-center">
              <div
                class="ceo-img bg-cover"
                style="background-image: url('assets/img/man-img.jpg')"
              ></div>
              <div class="ceo-info">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 ps-0 col-3 text-end">
            <div class="services-carousel-nav-prev">
              <i class="fal fa-long-arrow-left"></i>
            </div>
            <div class="services-carousel-nav-next">
        ...
        <div class="col-md-12 col-12">
          <div class="services-carousel-active">
            <div class="single-service-card">
              <div
                class="service-banner-img bg-cover"
                style="background-image: url('assets/img/services/air.jpg')"
              ></div>
              <div class="content">
            ...
            <div class="single-service-card">
              <div
                class="service-banner-img bg-cover"
                style="background-image: url('assets/img/services/ship.jpg')"
              ></div>
              <div class="content">
            ...
            <div class="single-service-card">
              <div
                class="service-banner-img bg-cover"
                style="background-image: url('assets/img/services/road.jpg')"
              ></div>
              <div class="content">
                <h3><a href="services-details">Road Freight</a></h3>
                <p>
                  Cargo are transported at some stage of their journey along the
                  world’s roads where we give you a reassuring presence.
                </p>
              </div>
            </div>
            <div class="single-service-card">
              <div
                class="service-banner-img bg-cover"
                style="
                  background-image: url('assets/img/services/warehouse.jpg');
                "
              ></div>
              <div class="content">
                <h3><a href="services-details">Warehousing</a></h3>
                <p>
                  Package and store your things effectively and securely to make
                  sure them in storage. best warehouse for your products.
                </p>
              </div>
            </div>
            <div class="single-service-card">
              ...
              <div class="content">
                ...
                <p>
                  Ship are transported at some stage of their journey along the
                  world’s roads where we give you a reassuring presence.
                </p>
              </div>
            </div>
            <div class="single-service-card">
              <div
                class="service-banner-img bg-cover"
                style="background-image: url('assets/img/services/rail.jpg')"
              ></div>
              <div class="content">
                <h3><a href="services-details">Continental Rail</a></h3>
                <p>
                  Continental Rail are transported at some stage of their
                  journey along the world’s roads where we give you a presence.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 col-12">
            <div
              class="team-member-card bg-cover"
              style="background-image: url('/assets/img/admin.jpeg')"
            >
          ...
          <div class="col-xl-3 col-md-6 col-12">
            <div
              class="team-member-card bg-cover"
              style="background-image: url('/assets/img/founder.jpeg')"
            >
              <div class="profile-info-card">
                <span>Founder</span>
          ...
          <div class="col-xl-3 col-md-6 col-12">
            <div
              class="team-member-card bg-cover"
              style="background-image: url('assets/img/ctoo.jpeg')"
            >
              <div class="profile-info-card">
                <span>CTOO</span>
          ...
          <div class="col-xl-3 col-md-6 col-12">
            <div
              class="team-member-card bg-cover"
              style="background-image: url('/assets/img/support.jpeg')"
            >
              <div class="profile-info-card">
                <span>Support</span>
    ...
    <section
      class="request-a-quote-section theme-bg bg-cover calculate-wrapper section-padding"
        ...
        <div class="single-price-bar">
          <div class="row align-items-center">
            ...
            <div class="col-xl-3 text-xl-end">
              <a href="#" class="theme-btn minimal-btn"
                >get started <i class="fal fa-long-arrow-right"></i
              ></a>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 col-xl-4 col-12">
            <div class="single-testimonial-card text-center">
              <div
                class="client-img bg-cover bg-center"
                style="background-image: url('assets/img/blog/author2.jpg')"
              ></div>
          ...
          <div class="col-md-6 col-xl-4 col-12">
            <div class="single-testimonial-card text-center">
              <div
                class="client-img bg-cover bg-center"
                style="background-image: url('assets/img/blog/author3.jpg')"
              ></div>
              <div class="client-info">
                <h4>Ernest Smith</h4>
          ...
          <div class="col-md-6 col-xl-4 col-12">
            <div class="single-testimonial-card text-center">
              <div
                class="client-img bg-cover bg-center"
                style="background-image: url('assets/img/blog/author_img.jpg')"
              ></div>
              <div class="client-info">
                <h4>Salman Ahmed</h4>
    ...
    <div
      class="video-pop-up-wrapper section-padding bg-cover"
    ...
    <section
      class="brand-showcase-funfact-wrapper section-padding bg-contain bg-center"
      style="background-image: url('assets/img/dot_map.png')"
    >
      <div class="container">
        <div class="col-12 text-center mb-20 mtm-20">
          <div
            class="mask-outline bg-center"
            style="background-image: url('assets/img/mask-bg.jpg')"
          >
            <h1>20,8700</h1>
          </div>
    ...
    <section
      class="cta-wrapper section-padding bg-overlay bg-cover"
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-12">
            <div
              class="single-news-card bg-cover"
              style="background-image: url('assets/img/blog/b1.jpg')"
            >
              <div class="contents">
                ...
                <h5>
                  <a href="news-details"
                    >Means of transportation is of the different kinds transport
                    facilities used.</a
                  >
                </h5>
                <div class="post-author">
                  <div
                    class="author-img bg-cover bg-center"
                    style="background-image: url('assets/img/blog/author2.jpg')"
                  ></div>
          ...
          <div class="col-lg-4 col-md-6 col-12">
            <div
              class="single-news-card active bg-cover"
              style="background-image: url('assets/img/blog/b1.jpg')"
            >
              <div class="contents">
                <div class="post-cat-date d-flex align-items-center">
                  <div class="post-cat">
                    ...
                    <a href="news">package</a>
                  </div>
                  <div class="post-date">December 31, 2021</div>
                </div>
                <h5>
                  <a href="news-details"
                    >Road, air and sea transport are available. Air transport is
                    the best way</a
                  >
                </h5>
                <div class="post-author">
            ...
            >
              <div class="contents">
                <div class="post-cat-date d-flex align-items-center">
                  ...
                  <div class="post-date">May 05, 2024</div>
                </div>
                <h5>
                  <a href="news-details"
                    >Key Logistics Trends in Life Sciences 2021. 5 Benefits of
                    Working with a Broker</a
                  >
                </h5>
                <div class="post-author">
                  <div
                    class="author-img bg-cover bg-center"
                    style="background-image: url('assets/img/blog/author1.jpg')"
                  ></div>
                  <div class="author-info">
                    <h6>Teen Tycoon</h6>
                    <span>CMS</span>
                ...
                <div class="get-in-touch">
                  <div class="single-contact-info">
                    ...
                    <div class="contact-info">
                      <span>942 S Shady Grove Rd, Memphis, TN</span>
                    </div>
                  </div>
                  <div class="single-contact-info">
                    <div class="icon id2">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form
                action="https://bluegatecargo.com/search/currier"
                method="post"
              >
                <input
                  type="hidden"
                  name="_token"
                  value="y4Z3GAKsrLLvnVoS916O9SscarlrsEVdpFUdv8Gg"
                />
  ...
  <!-- Mirrored from codexpeed.com/html/CarGo Care Hub-html/index by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2024 10:07:07 GMT -->
</html>
