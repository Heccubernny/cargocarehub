<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from codexpeed.com/html/CarGo Care Hub-html/team-details by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2024 10:09:01 GMT -->
  ...
  <body class="body-wrapper">
      ...
      <div class="container">
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">jone doe</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <section class="team-member-details-wrapper section-padding">
      <div class="container">
        <div class="member-profile-wrapper">
          <div class="row align-items-center">
            <div class="col-lg-4 col-xl-3 col-md-4">
              <div class="member-profile-img bg-cover bg-center" style="background-image: url('assets/img/team/3.jpg')">
              </div>
            </div>
            <div class="col-lg-8 d-sm-flex justify-content-between col-md-8 col-xl-9">
              <div class="member-info">
                ...
                <p>
                  Business blogging is as essential to marketing a business as
                  the yellowpages. A business blog is a marketing channel that
                  helps businesses increase visibility online
                </p>
          ...
          <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-12">
              <div class="biography-info">
                <p>
                  Business blogging is as essential to marketing a business as
                  the yellow pages. A business blog is a marketing channel that
                  helps businesses increase visibility online. Now, this one is
                  flat-out wrong today. There are millions being made off of
                  blogging these days. At the time, they were all valid points
                  to consider, These six statements represent common beliefs
                    ...
                    <div class="single-progress-bar">
                      ...
                      <div class="progress">
                        <div class="progress-bar wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".9s"
                          role="progressbar" style="width: 93%"></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6 col-12">
        ...
        <div class="member-contact-form mmb-20">
          <div class="row">
            <div class="col-lg-3 col-md-4 text-center col-12">
              <div class="icon-box">
                <div class="icon">
            ...
            <div class="col-lg-9 col-md-8 col-12">
              <div class="contact-form7-wrapper">
                <div class="contact-form">
                  <form action="https://codexpeed.com/html/CarGo Care Hub-html/mail.php" class="row" id="contact-form">
                    <div class="col-md-6 col-12">
                ...
                <div class="get-in-touch">
                  <div class="single-contact-info">
                    ...
                    <div class="contact-info">
                      <span>9942 S Shady Grove Rd, Memphis, TN</span>
                    </div>
                  </div>
                  <div class="single-contact-info">
                    <div class="icon id2">
