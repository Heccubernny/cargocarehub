                            ...
                            <div class="mobile-nav">
                                ...
                                <nav class="sidebar-nav">
                                    <ul class="metismenu" id="mobile-menu">
                                        <li><a class="has-arrow" href="../index">Homes</a>
        ...
        <section class="about-us-wrapper section-padding">
            ...
            if (isset($_SESSION['track']) && $_SESSION['track'] !== null) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <b>Welcome,</b> | <a href="../index"> Back to Homepage </a>
                    </div>
...
<div class="text-center my-12">
                    <a href="{{ url('track/pdf', $data->tracking_number) }}" class="btn btn-primary">Download Invoice</a>
                </div>
                    <div class="timeline">
                         <div class="timeline_container timeline_left">
                            <div class="timeline_content">
                                <h2>Dispatch</h2>
                                <p><b>Date:</b> {{ $data->dispatch_date }}</p>
                                <p><b>Location:</b> {{ $data->dispatch_location }}</p>
                                <p><b>Status:</b> {{ $dispatchStatusMessage }}</p>
                            </div>
                        </div>
                        <div class="timeline_container timeline_right">
                            <div class="timeline_content">
                                <h2>Current</h2>
                                <p><b>Date:</b> {{ $data->current_location_date }}</p>
                                <p><b>Location:</b> {{ $data->current_location == "" ? $data->dispatch_location : $data->current_location }}</p>
                                <p><b>Status:</b> {{ $currentStatusMessage }}</p>
                            </div>
                        </div>
                        <div class="timeline_container timeline_left">
                            <div class="timeline_content">
                                <h2>Destination</h2>
                                <p><b>Date:</b> {{ $data->delivery_date }}</p>
                                <p><b>Location:</b> {{ $data->receiver_address }}</p>
                                <p><b>Status:</b> {{ $destinationStatusMessage }}</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><b>Contact:</b> </td>
                                                <td>
                                                    <?php echo $data['receiver_contact'] ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><b>Email:</b> </td>
                                            ...
                                            <tr>
                                                <td><b>Address:</b></td>
                                                <td>
                                                    <?php echo $data['receiver_address'] ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <table class="table table-striped table-bordered table-condensed">
                            <tbody>
                                <tr>
                                    ...
                                    <td> <img src="./uploads/<?php echo $data['product_image'] ?>" width="100"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $data['percentage_on_delivery'] ?>%
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $data['dispatch_location'] ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="text-right"><b>Current Location <img src="../loading.gif"
                                                style="height: 30px; width: 50px"> </b></td>
                                    <td class="col-xs-6">
                                        <marquee>
                ...
                <div class="col-md-12 " style="margin: auto">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="/track" method="post" style="margin bottom:50px">
                                @csrf
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Enter Tracking Code" name="tnumber"
                                    value="" style="width:350px; background-color: lightgrey">
                                <br>
